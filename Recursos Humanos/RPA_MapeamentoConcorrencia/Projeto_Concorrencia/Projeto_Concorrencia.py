...
def matchbox():
    ...
    bot.refresh()
    bot.wait(5000)                                                                        
    nome_programa_matchbox_selector = bot.find_elements("//*[@id='links-container']/div[position() <= 3]",By.XPATH)
    links_programas_matchbox_selector = bot.driver.find_elements_by_xpath("//*[@id='links-container']/div[position() <= 3]")
