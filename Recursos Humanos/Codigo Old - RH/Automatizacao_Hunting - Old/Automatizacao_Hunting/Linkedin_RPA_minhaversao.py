...
def getEducation():
    ...
    formacoes_selector = driver.find_element(By.XPATH, '//li[@class="pvs-list__paged-list-item artdeco-list__item pvs-list__item--line-separated pvs-list__item--one-column"]')
...
def getLanguages():
    ...
    nomes_idiomas_selector = driver.find_element(By.XPATH, "//div[contains(concat(' ', normalize-space(@class), ' '), ' display-flex align-items-center mr1 t-bold ')]/span[1]")
    ...
    try:
         niveis_idiomas_selector = driver.find_element(By.XPATH, "//*[@class='t-14 t-normal t-black--light']/span[1]")
    except:
        niveis_idiomas_selector = ["Não tem", "Não tem", "Não tem"]
...
def body():
    ...
    for linha in range(2, len(sheet_selecionada['A']) + 1):
        ...
        try:
            pagina_nao_existe = driver.find_element(By.XPATH,"//h2[contains(@class, 'artdeco-empty-state__headline')]")
        ...
        try:
            pagina_nao_encontrada = driver.find_element(By.XPATH,"//h1[@class='heading' and contains(text(), 'Page not found')]")
        ...
        try:
            pagina_nao_encontrada = driver.find_element(By.XPATH,"//h1[@class='heading' and contains(text(), 'Página não encontrada')]")
            pagina_nao_encontrada = pagina_nao_encontrada.text
